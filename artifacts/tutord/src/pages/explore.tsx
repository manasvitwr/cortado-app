    ...
    <Layout>
      <div className="space-y-8 animate-in fade-in duration-500 w-full">
        <header className="px-1">
          ...
          <p className="text-muted-foreground mt-2 font-medium">Discover popular tutorials and curated lists.</p>
        </header>
        ...
        {isLoading ? (
          ...
          <div className="p-8 bg-card rounded-[2rem] border border-border text-center shadow-xl">
            <p className="text-destructive font-bold">Failed to load explore data.</p>
          </div>
        ) : (
